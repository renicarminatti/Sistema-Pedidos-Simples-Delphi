...
uses
  ...
  Vcl.Graphics, Vcl.Dialogs,Data.DB, FireDAC.Stan.Intf, FireDAC.Stan.Option,
  FireDAC.Stan.Param,  FireDAC.Stan.Error, FireDAC.DatS, FireDAC.Phys.Intf,
  FireDAC.Stan.Async, FireDAC.DApt, Vcl.ComCtrls, FireDAC.Comp.DataSet,
  FireDAC.Comp.Client, Vcl.StdCtrls, Vcl.ExtCtrls, Vcl.Buttons, Vcl.Grids,
  Vcl.DBGrids, Vcl.Controls, System.Classes,Vcl.Forms, System.StrUtils,
  FireDAC.DApt.Intf, Model.Cliente, Model.Item, Model.Pedido, Model.Produto;
type
  TfPDV = class(TForm)
